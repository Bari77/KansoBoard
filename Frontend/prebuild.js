...
var pkg = JSON.parse(fs.readFileSync(path.resolve('./package.json'), FILE_ENCODING));
var versionTs = "// Generated by prebuild.js - do not edit\nexport const APP_VERSION = '" + pkg.version + "';\n";
fs.writeFileSync(path.resolve('./src/app/version.ts'), versionTs, FILE_ENCODING);
console.log("[Version] Written APP_VERSION = " + pkg.version);
